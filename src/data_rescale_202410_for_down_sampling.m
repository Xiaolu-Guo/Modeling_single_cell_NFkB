function [] = data_rescale_202410_for_down_sampling(rescale_factor,ligand_index,dose_index,params)
% updated on 11/24/2021
% rescale the data using the rescaling factor
% for down sampling, but here does not remove the data
...
sti_info.data_name_rescale = strcat('2024_',sti_info.data_name_rescale);
