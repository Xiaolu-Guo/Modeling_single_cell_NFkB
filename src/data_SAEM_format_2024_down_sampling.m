function [] = data_SAEM_format_2024_down_sampling(data_info,params)
...
for sti_index= 1: length(data_info.ligand_vec)
    ...
    % down sampling here
    exp_data_wr = exp_data_wr(:,1:2:end);
    time_matrix_wr = time_matrix_wr(:,1:2:end);

    for i_cell=1:size(time_matrix_wr,2)
