...
% 
%     ligand_index = 4; %TNF:1  CpG:2  LPS:3  Pam3CSK:4  PolyIC:5
% 
...
if 1
    ...
    %TNF:1  CpG:2  LPS:3  Pam3CSK:4  PolyIC:5
    ...
    sheetname = 'Ade_exp_data_2023';
    
    params.write_SAEM_data_filename = generate_SAEM_data_filename_down_sampling_20241001(data_info,sheetname);
    
    params.write_SAEM_data_filename = strcat(params.save_path,'down_sampling_',params.write_SAEM_data_filename);
    ...
    if SAEM_save
        data_SAEM_format_2024_down_sampling(data_info,params)
